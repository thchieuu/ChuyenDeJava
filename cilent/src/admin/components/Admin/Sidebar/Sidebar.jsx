  ...
  return (
    <aside className="app-sidebar">
      ...
      <ul className="app-menu">
        <li>
          <NavLink className="app-menu__item" activeClassName="active" to="/admin/dashboard">
            <i className="app-menu__icon bx bx-tachometer"></i> 
            <span className="app-menu__label">Bảng điều khiển</span>
          </NavLink>
        </li>
        <li>
          <NavLink className="app-menu__item" activeClassName="active" to="/admin/news-management">
            <i className="app-menu__icon bx bx-id-card"></i>
            <span className="app-menu__label">Quản lý bài viết</span>
          </NavLink>
        </li>
        <li>
          <NavLink className="app-menu__item" activeClassName="active" to="/admin/users-management">
            <i className="app-menu__icon bx bx-id-card"></i>
            <span className="app-menu__label">Quản lý người đọc</span>
          </NavLink>
        </li>
        <li>
          <NavLink className="app-menu__item" activeClassName="active" to="/admin/comments-management">
            <i className="app-menu__icon bx bx-id-card"></i>
